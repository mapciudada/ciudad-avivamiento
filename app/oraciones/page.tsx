        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center mb-12">
             <h1 className="text-4xl md:text-6xl font-black text-white tracking-tighter mb-6">
              Peticiones de <span className="text-[#FFE800]">Oración</span>
            </h1>
            ...
            {/* Separador amarillo */}
            <div className="h-1 w-20 bg-[#FFE800] mx-auto mb-6"></div>
            <p className="text-[#FFE800] font-medium uppercase tracking-widest text-sm">
            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input 
                    type="text" 
                    className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:border-[#FFE800] outline-none transition-all"
              ...
              <div>
                ...
                <textarea 
                  rows={5}
                  className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:border-[#FFE800] outline-none transition-all resize-none"
              ...
              <button 
                type="submit"
                // Botón amarillo con sombra dorada
                className="w-full py-4 rounded-xl bg-[#FFE800] text-black font-extrabold text-lg hover:shadow-[0_0_30px_rgba(255,232,0,0.4)] hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-3"
              >
                <Send size={20} />
                Enviar Petición
              </button>
