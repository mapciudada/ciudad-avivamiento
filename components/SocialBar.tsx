    ...
    <div className="bg-[#050505] py-12 border-t border-white/5">
      <div className="container mx-auto px-4 flex flex-col items-center md:items-end">
        ...
        <div className="flex flex-wrap justify-center md:justify-end gap-8 md:gap-12 text-white/20">
          {/* Todos los hovers actualizados a AMARILLO */}
          <a href={urls.whatsapp} target="_blank" className="hover:text-[#FFE800] transition-colors"><MessageCircle size={26} strokeWidth={1.5} /></a>
          <a href={urls.igMinistry} target="_blank" className="hover:text-[#FFE800] transition-colors"><Instagram size={26} strokeWidth={1.5} /></a>
          <a href={urls.tiktok} target="_blank" className="hover:text-[#FFE800] transition-colors">
          ...
          <a href={urls.facebook} target="_blank" className="hover:text-[#FFE800] transition-colors"><Facebook size={26} strokeWidth={1.5} /></a>
          <a href={urls.x} target="_blank" className="hover:text-[#FFE800] transition-colors">
          ...
          <a href={urls.telegram} target="_blank" className="hover:text-[#FFE800] transition-colors"><Send size={26} strokeWidth={1.5} /></a>
          <a href={urls.ytChannel} target="_blank" className="hover:text-[#FFE800] transition-colors"><Youtube size={28} strokeWidth={1.5} /></a>
          <a href={urls.linkedin} target="_blank" className="hover:text-[#FFE800] transition-colors"><Linkedin size={26} strokeWidth={1.5} /></a>
        </div>
      </div>
    </div>
  );
